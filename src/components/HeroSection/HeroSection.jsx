    ...
    <section className="relative h-[85vh] flex items-center justify-center text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-3xl text-center px-6 animate-fadeIn">
        ...
        <div className="flex justify-center gap-4">
          ...
          <Link to={'https://dfpi.ca.gov/wp-content/uploads/sites/337/2019/06/8_Tips_for_Financial_Success.pdf'} className="px-6 py-3 border border-white rounded-full text-white font-semibold hover:bg-white hover:text-teal-700 transition-all duration-300 cursor-pointer">
            Learn More
          </Link>
        </div>
      </div>
