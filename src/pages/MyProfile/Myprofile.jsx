...
const MyProfile = () => {
  ...
  return (
    <div
      className={`min-h-screen flex justify-center items-center px-4 py-16 transition-all duration-500 ${isDarkMode
          ? "bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900"
          : "bg-gradient-to-br from-green-50 to-teal-50"
        }`}
    >
      <div
        className={`shadow-xl rounded-2xl p-8 w-full max-w-md border text-center transition-all duration-500 ${isDarkMode
      ...
      {showModal && (
        <div
          className={`fixed inset-0 flex items-center justify-center z-50 transition-all duration-500 ${isDarkMode ? "bg-black/60" : "bg-gray-900/30"
            }`}
        >
          <div
            className={`rounded-2xl p-6 w-full max-w-md border shadow-2xl transition-all duration-500 ${isDarkMode
                ? "bg-gray-800 border-gray-700 text-gray-100"
                : "bg-white border-teal-100 text-gray-800"
              }`}
          >
            ...
            <form onSubmit={handleUpdate} className="space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full p-3 rounded-lg outline-none focus:border-emerald-500 transition border ${isDarkMode
              ...
              <div className="flex justify-between mt-4">
                <button
                  ...
                  className={`px-4 py-2 rounded-lg border transition cursor-pointer ${isDarkMode
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-green-600 to-teal-600 text-white px-6 py-2 rounded-lg font-medium hover:opacity-90 transition cursor-pointer disabled:opacity-50"
                >
